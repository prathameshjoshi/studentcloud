...
public class LoginLogoutController {
	...
	public String getLoginPage(
			...
			ModelMap model) {
		logger.debug(" ** getLoginPage method of LoginLogoutController Invoked ** ");
		...
		logger.debug(" ** getLoginPage method of LoginLogoutController Revoked ** ");
	...
	public String getDeniedPage() {
		logger.debug(" ** getDeniedPage method of LoginLogoutController Invoked ** ");
		logger.debug(" ** getDeniedPage method of LoginLogoutController Revoked ** ");
